...
export default () => (
  <MainLayout pageTitle="About Us">
    <Section heading="Hello and welcome to Beespoked">
      <p className="u-mb-4">
      ...
      <p className="u-mb-4">
        ...
        accurately and then the teenagers says whether they are any good or not. The cat just visits when he's hungry! It seems to work
        quite well as long as people stick to their own jobs.
      </p>
      <p className="u-mb-4">
