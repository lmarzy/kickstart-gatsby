...
export default () => (
  <MainLayout pageTitle="Delivery">
    ...
    <p className="u-mb-3">
      Should your item not arrive, we ask that you allow 10 working days from the date of despatch. At this point we can either offer a full
      refund or a replacement item.
    </p>
    ...
    <p className="u-mb-3">
      Despatch times are kept to a minimum. We aim to despatch within 5 working days or sooner. Sometimes we may be waiting for stock. If we
      have any problems despatching an item within this time frame we will contact you asap. You will be entitled to cancel the order is the
      despatch time is unacceptable.
    </p>
  </MainLayout>
);
